...
@cython.boundscheck(False) # turn of bounds-checking for entire function
def compute(np.ndarray[DTYPE_t, ndim=3] dm_den, np.ndarray[DTYPE_t, ndim=3] nu_den, np.ndarray[DTYPE_t, ndim=3] vx, np.ndarray[DTYPE_t, ndim=3] vy, np.ndarray[DTYPE_t, ndim=3] vz, unsigned int Nden, unsigned int num):
