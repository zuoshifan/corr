...
int main(int argc, char *argv[])
{
    ...
    double vec_upx[3] = { 1./sqrt(2.), 0, 1./sqrt(2.)};
    double vec_unx[3] = {-1./sqrt(2.), 0, 1./sqrt(2.)};
    double vec_upy[3] = {0,  1./sqrt(2.), 1./sqrt(2.)};
    double vec_uny[3] = {0, -1./sqrt(2.), 1./sqrt(2.)};
    double vec_dpx[3] = { 1./sqrt(2.), 0, -1./sqrt(2.)};
    double vec_dnx[3] = {-1./sqrt(2.), 0, -1./sqrt(2.)};
    double vec_dpy[3] = {0,  1./sqrt(2.), -1./sqrt(2.)};
    double vec_dny[3] = {0, -1./sqrt(2.), -1./sqrt(2.)};
    double vec_m1[3] = { 1./sqrt(2.), -1./sqrt(2.), 0};
    double vec_m2[3] = { 1./sqrt(2.),  1./sqrt(2.), 0};
    double vec_m3[3] = {-1./sqrt(2.),  1./sqrt(2.), 0};
    double vec_m4[3] = {-1./sqrt(2.), -1./sqrt(2.), 0};

    double vec_u1[3] = { 1./sqrt(3.), -1./sqrt(3.), 1./sqrt(3.)};
    double vec_u2[3] = { 1./sqrt(3.),  1./sqrt(3.), 1./sqrt(3.)};
    double vec_u3[3] = {-1./sqrt(3.),  1./sqrt(3.), 1./sqrt(3.)};
    double vec_u4[3] = {-1./sqrt(3.), -1./sqrt(3.), 1./sqrt(3.)};
    double vec_d1[3] = { 1./sqrt(3.), -1./sqrt(3.), -1./sqrt(3.)};
    double vec_d2[3] = { 1./sqrt(3.),  1./sqrt(3.), -1./sqrt(3.)};
    double vec_d3[3] = {-1./sqrt(3.),  1./sqrt(3.), -1./sqrt(3.)};
    double vec_d4[3] = {-1./sqrt(3.), -1./sqrt(3.), -1./sqrt(3.)};
        ...
        for(k = 1; k < l_index; k++)  // Increasing z index
        {
            for(j = 1; j < l_index; j++)  // Increasing y index
            {
                for(i = 1; i < l_index; i++) // Increasing x index
                {
                    ...
                    vx_med = (vx_bg[index_0]*2. + 0*vx_bg[index_px])/2.;//px 1
                    vy_med = (vy_bg[index_0]*2. + 0*vy_bg[index_px])/2.;
                    vz_med = (vz_bg[index_0]*2. + 0*vz_bg[index_px])/2.;
                    ...
                    vx_med = (vx_bg[index_0]*2. + 0*vx_bg[index_nx])/2.;//nx 2
                    vy_med = (vy_bg[index_0]*2. + 0*vy_bg[index_nx])/2.;
                    vz_med = (vz_bg[index_0]*2. + 0*vz_bg[index_nx])/2.;
                    v_mag = sqrt(vx_med*vx_med + vy_med*vy_med + vz_med*vz_med);
                    v_dir[0] = vx_med/v_mag;
                    v_dir[1] = vy_med/v_mag;
                    v_dir[2] = vz_med/v_mag;
                    ...
                    vx_med = (vx_bg[index_0]*2. + 0*vx_bg[index_py])/2.;//py 3
                    vy_med = (vy_bg[index_0]*2. + 0*vy_bg[index_py])/2.;
                    vz_med = (vz_bg[index_0]*2. + 0*vz_bg[index_py])/2.;
                    v_mag = sqrt(vx_med*vx_med + vy_med*vy_med + vz_med*vz_med);
                    v_dir[0] = vx_med/v_mag;
                    v_dir[1] = vy_med/v_mag;
                    v_dir[2] = vz_med/v_mag;
                    ...
                    vx_med = (vx_bg[index_0]*2. + 0*vx_bg[index_ny])/2.;//ny 4
                    vy_med = (vy_bg[index_0]*2. + 0*vy_bg[index_ny])/2.;
                    vz_med = (vz_bg[index_0]*2. + 0*vz_bg[index_ny])/2.;
                    v_mag = sqrt(vx_med*vx_med + vy_med*vy_med + vz_med*vz_med);
                    v_dir[0] = vx_med/v_mag;
                    v_dir[1] = vy_med/v_mag;
                    v_dir[2] = vz_med/v_mag;
                    ...
                    vx_med = (vx_bg[index_0]*2. + 0*vx_bg[index_pz])/2.;//pz 5
                    vy_med = (vy_bg[index_0]*2. + 0*vy_bg[index_pz])/2.;
                    vz_med = (vz_bg[index_0]*2. + 0*vz_bg[index_pz])/2.;
                    v_mag = sqrt(vx_med*vx_med + vy_med*vy_med + vz_med*vz_med);
                    v_dir[0] = vx_med/v_mag;
                    v_dir[1] = vy_med/v_mag;
                    v_dir[2] = vz_med/v_mag;
                    ...
                    vx_med = (vx_bg[index_0]*2. + 0*vx_bg[index_nz])/2.;//nz 6
                    vy_med = (vy_bg[index_0]*2. + 0*vy_bg[index_nz])/2.;
                    vz_med = (vz_bg[index_0]*2. + 0*vz_bg[index_nz])/2.;
                    v_mag = sqrt(vx_med*vx_med + vy_med*vy_med + vz_med*vz_med);
                    v_dir[0] = vx_med/v_mag;
                    v_dir[1] = vy_med/v_mag;
                    v_dir[2] = vz_med/v_mag;
                    ...
                    vx_med = (vx_bg[index_0]*2. + 0*vx_bg[index_upx])/2.;//upx 1
                    vy_med = (vy_bg[index_0]*2. + 0*vy_bg[index_upx])/2.;
                    vz_med = (vz_bg[index_0]*2. + 0*vz_bg[index_upx])/2.;
                    v_mag = sqrt(vx_med*vx_med + vy_med*vy_med + vz_med*vz_med);
                    v_dir[0] = vx_med/v_mag;
                    v_dir[1] = vy_med/v_mag;
                    v_dir[2] = vz_med/v_mag;
                    ...
                    vx_med = (vx_bg[index_0]*2. + 0*vx_bg[index_unx])/2.;//unx 2
                    vy_med = (vy_bg[index_0]*2. + 0*vy_bg[index_unx])/2.;
                    vz_med = (vz_bg[index_0]*2. + 0*vz_bg[index_unx])/2.;
                    v_mag = sqrt(vx_med*vx_med + vy_med*vy_med + vz_med*vz_med);
                    v_dir[0] = vx_med/v_mag;
                    v_dir[1] = vy_med/v_mag;
                    v_dir[2] = vz_med/v_mag;
                    ...
                    vx_med = (vx_bg[index_0]*2. + 0*vx_bg[index_upy])/2.;//upy 3
                    vy_med = (vy_bg[index_0]*2. + 0*vy_bg[index_upy])/2.;
                    vz_med = (vz_bg[index_0]*2. + 0*vz_bg[index_upy])/2.;
                    v_mag = sqrt(vx_med*vx_med + vy_med*vy_med + vz_med*vz_med);
                    v_dir[0] = vx_med/v_mag;
                    v_dir[1] = vy_med/v_mag;
                    v_dir[2] = vz_med/v_mag;
                    ...
                    vx_med = (vx_bg[index_0]*2. + 0*vx_bg[index_uny])/2.;//uny 4
                    vy_med = (vy_bg[index_0]*2. + 0*vy_bg[index_uny])/2.;
                    vz_med = (vz_bg[index_0]*2. + 0*vz_bg[index_uny])/2.;
                    v_mag = sqrt(vx_med*vx_med + vy_med*vy_med + vz_med*vz_med);
                    v_dir[0] = vx_med/v_mag;
                    v_dir[1] = vy_med/v_mag;
                    v_dir[2] = vz_med/v_mag;
                    ...
                    vx_med = (vx_bg[index_0]*2. + 0*vx_bg[index_dpx])/2.;//dpx 5
                    vy_med = (vy_bg[index_0]*2. + 0*vy_bg[index_dpx])/2.;
                    vz_med = (vz_bg[index_0]*2. + 0*vz_bg[index_dpx])/2.;
                    v_mag = sqrt(vx_med*vx_med + vy_med*vy_med + vz_med*vz_med);
                    v_dir[0] = vx_med/v_mag;
                    v_dir[1] = vy_med/v_mag;
                    v_dir[2] = vz_med/v_mag;
                    ...
                    vx_med = (vx_bg[index_0]*2. + 0*vx_bg[index_dnx])/2.;//dnx 6
                    vy_med = (vy_bg[index_0]*2. + 0*vy_bg[index_dnx])/2.;
                    vz_med = (vz_bg[index_0]*2. + 0*vz_bg[index_dnx])/2.;
                    v_mag = sqrt(vx_med*vx_med + vy_med*vy_med + vz_med*vz_med);
                    v_dir[0] = vx_med/v_mag;
                    v_dir[1] = vy_med/v_mag;
                    v_dir[2] = vz_med/v_mag;
                    ...
                    vx_med = (vx_bg[index_0]*2. + 0*vx_bg[index_dpy])/2.;//dpy 7
                    vy_med = (vy_bg[index_0]*2. + 0*vy_bg[index_dpy])/2.;
                    vz_med = (vz_bg[index_0]*2. + 0*vz_bg[index_dpy])/2.;
                    v_mag = sqrt(vx_med*vx_med + vy_med*vy_med + vz_med*vz_med);
                    v_dir[0] = vx_med/v_mag;
                    v_dir[1] = vy_med/v_mag;
                    v_dir[2] = vz_med/v_mag;
                    ...
                    vx_med = (vx_bg[index_0]*2 + 0*vx_bg[index_dny])/2.;//dny 8
                    vy_med = (vy_bg[index_0]*2 + 0*vy_bg[index_dny])/2.;
                    vz_med = (vz_bg[index_0]*2 + 0*vz_bg[index_dny])/2.;
                    v_mag = sqrt(vx_med*vx_med + vy_med*vy_med + vz_med*vz_med);
                    v_dir[0] = vx_med/v_mag;
                    v_dir[1] = vy_med/v_mag;
                    v_dir[2] = vz_med/v_mag;
                    ...
                    vx_med = (vx_bg[index_0]*2. + 0*vx_bg[index_m1])/2.;//m1  9
                    vy_med = (vy_bg[index_0]*2. + 0*vy_bg[index_m1])/2.;
                    vz_med = (vz_bg[index_0]*2. + 0*vz_bg[index_m1])/2.;
                    v_mag = sqrt(vx_med*vx_med + vy_med*vy_med + vz_med*vz_med);
                    v_dir[0] = vx_med/v_mag;
                    v_dir[1] = vy_med/v_mag;
                    v_dir[2] = vz_med/v_mag;
                    ...
                    vx_med = (vx_bg[index_0]*2. + 0*vx_bg[index_m2])/2.;//m2  10
                    vy_med = (vy_bg[index_0]*2. + 0*vy_bg[index_m2])/2.;
                    vz_med = (vz_bg[index_0]*2. + 0*vz_bg[index_m2])/2.;
                    v_mag = sqrt(vx_med*vx_med + vy_med*vy_med + vz_med*vz_med);
                    v_dir[0] = vx_med/v_mag;
                    v_dir[1] = vy_med/v_mag;
                    v_dir[2] = vz_med/v_mag;
                    ...
                    vx_med = (vx_bg[index_0]*2. + 0*vx_bg[index_m3])/2.;//m3  11
                    vy_med = (vy_bg[index_0]*2. + 0*vy_bg[index_m3])/2.;
                    vz_med = (vz_bg[index_0]*2. + 0*vz_bg[index_m3])/2.;
                    v_mag = sqrt(vx_med*vx_med + vy_med*vy_med + vz_med*vz_med);
                    v_dir[0] = vx_med/v_mag;
                    v_dir[1] = vy_med/v_mag;
                    v_dir[2] = vz_med/v_mag;
                    ...
                    vx_med = (vx_bg[index_0]*2. + 0*vx_bg[index_m4])/2.;//m4  12
                    vy_med = (vy_bg[index_0]*2. + 0*vy_bg[index_m4])/2.;
                    vz_med = (vz_bg[index_0]*2. + 0*vz_bg[index_m4])/2.;
                    v_mag = sqrt(vx_med*vx_med + vy_med*vy_med + vz_med*vz_med);
                    v_dir[0] = vx_med/v_mag;
                    v_dir[1] = vy_med/v_mag;
                    v_dir[2] = vz_med/v_mag;
                    ...
                    vx_med = (vx_bg[index_0]*2. + 0*vx_bg[index_u1])/2.;//u1  1
                    vy_med = (vy_bg[index_0]*2. + 0*vy_bg[index_u1])/2.;
                    vz_med = (vz_bg[index_0]*2. + 0*vz_bg[index_u1])/2.;
                    v_mag = sqrt(vx_med*vx_med + vy_med*vy_med + vz_med*vz_med);
                    v_dir[0] = vx_med/v_mag;
                    v_dir[1] = vy_med/v_mag;
                    v_dir[2] = vz_med/v_mag;
                    ...
                    vx_med = (vx_bg[index_0]*2. + 0*vx_bg[index_u2])/2.;//u2  2
                    vy_med = (vy_bg[index_0]*2. + 0*vy_bg[index_u2])/2.;
                    vz_med = (vz_bg[index_0]*2. + 0*vz_bg[index_u2])/2.;
                    v_mag = sqrt(vx_med*vx_med + vy_med*vy_med + vz_med*vz_med);
                    v_dir[0] = vx_med/v_mag;
                    v_dir[1] = vy_med/v_mag;
                    v_dir[2] = vz_med/v_mag;
                    ...
                    vx_med = (vx_bg[index_0]*2. + 0*vx_bg[index_u3])/2.;//u3  3
                    vy_med = (vy_bg[index_0]*2. + 0*vy_bg[index_u3])/2.;
                    vz_med = (vz_bg[index_0]*2. + 0*vz_bg[index_u3])/2.;
                    v_mag = sqrt(vx_med*vx_med + vy_med*vy_med + vz_med*vz_med);
                    v_dir[0] = vx_med/v_mag;
                    v_dir[1] = vy_med/v_mag;
                    v_dir[2] = vz_med/v_mag;
                    ...
                    vx_med = (vx_bg[index_0]*2. + 0*vx_bg[index_u4])/2.;//u4  4
                    vy_med = (vy_bg[index_0]*2. + 0*vy_bg[index_u4])/2.;
                    vz_med = (vz_bg[index_0]*2. + 0*vz_bg[index_u4])/2.;
                    v_mag = sqrt(vx_med*vx_med + vy_med*vy_med + vz_med*vz_med);
                    v_dir[0] = vx_med/v_mag;
                    v_dir[1] = vy_med/v_mag;
                    v_dir[2] = vz_med/v_mag;
                    ...
                    vx_med = (vx_bg[index_0]*2. + 0*vx_bg[index_d1])/2.;//d1  5
                    vy_med = (vy_bg[index_0]*2. + 0*vy_bg[index_d1])/2.;
                    vz_med = (vz_bg[index_0]*2. + 0*vz_bg[index_d1])/2.;
                    v_mag = sqrt(vx_med*vx_med + vy_med*vy_med + vz_med*vz_med);
                    v_dir[0] = vx_med/v_mag;
                    v_dir[1] = vy_med/v_mag;
                    v_dir[2] = vz_med/v_mag;
                    ...
                    vx_med = (vx_bg[index_0]*2. + 0*vx_bg[index_d2])/2.;//d2  6
                    vy_med = (vy_bg[index_0]*2. + 0*vy_bg[index_d2])/2.;
                    vz_med = (vz_bg[index_0]*2. + 0*vz_bg[index_d2])/2.;
                    v_mag = sqrt(vx_med*vx_med + vy_med*vy_med + vz_med*vz_med);
                    v_dir[0] = vx_med/v_mag;
                    v_dir[1] = vy_med/v_mag;
                    v_dir[2] = vz_med/v_mag;
                    ...
                    vx_med = (vx_bg[index_0]*2. + 0*vx_bg[index_d3])/2.;//d3  7
                    vy_med = (vy_bg[index_0]*2. + 0*vy_bg[index_d3])/2.;
                    vz_med = (vz_bg[index_0]*2. + 0*vz_bg[index_d3])/2.;
                    v_mag = sqrt(vx_med*vx_med + vy_med*vy_med + vz_med*vz_med);
                    v_dir[0] = vx_med/v_mag;
                    v_dir[1] = vy_med/v_mag;
                    v_dir[2] = vz_med/v_mag;
                    ...
                    vx_med = (vx_bg[index_0]*2. + 0*vx_bg[index_d4])/2.;//d4  8
                    vy_med = (vy_bg[index_0]*2. + 0*vy_bg[index_d4])/2.;
                    vz_med = (vz_bg[index_0]*2. + 0*vz_bg[index_d4])/2.;
                    v_mag = sqrt(vx_med*vx_med + vy_med*vy_med + vz_med*vz_med);
                    v_dir[0] = vx_med/v_mag;
                    v_dir[1] = vy_med/v_mag;
                    v_dir[2] = vz_med/v_mag;
